...
(defn about-us-content []
  [:div {:id "about-us-content"}
   (image "/img/aboutus_1_low.jpg" "Shell and Johnny in Montreal, Canada")
   ...
   [:h2 "Who are we?"]
   [:p
    (image "/img/aboutus_2_low.jpg" "Shell in Punmamarca, Argentina")]
   [:p [:strong "NAME: "] "Shell"]
   ...
   [:p [:strong "COUNTRIES VISITED: "] "China, Argentina, Uruguay, Colombia, Spain, Canada "]
   ...
   [:p 
    (image "/img/aboutus_3_low.jpg" "Johnny just outside of Mendoza, Argentina")]
   ...
   [:p [:strong "COUNTRIES VISITED: "] "USA, Argentina, Uruguay, UK, France, Spain, Canada"]
   [:p [:strong "FAVORITE THINGS TO DO WHILE TRAVELLING: "] "people watching, trying craft beer"]
